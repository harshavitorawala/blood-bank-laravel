                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            ...
                            <div class="data col-lg-6">
                                <h4>To: {{ $request->receiver->name }}</h4>
                                <h4>Email: {{ $request->receiver->email }}</h4>
                                <h4>Message: {{ $request->message }}</h4>
                                <h4>Sent At: {{ $request->created_at->format('d-m-Y H:i:s') }}</h4>

                            </div>
                            
                            <div class="col-lg-3">
                                <div class="type">
                                    <form method="POST" action="{{ route('requests.delete_request', $request->id) }}">
                                            @csrf
