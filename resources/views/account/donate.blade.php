...
<body>
    ...
    <section id="sign-up">
        <div class="container">
                ...
                <form action=" {{ route('account.registerDonor') }}" method="POST">
                    @csrf
                    <div class="row gy-3 overflow-hidden">
                        ...
                        <div class="col-12">
                            <div class="form-floating mb-3">
                                <input type="number" class="form-control @error('age') is-invalid @enderror" name="age" id="age" value="{{Auth::user()->age}}" >
                                @error('age')
                                    <p style="padding-left:170px; font-size:20px;" class="invalid-feedback">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="col-12">
                            <div class="form-floating mb-3">
                                <select name="bloodgroup" id="bloodgroup" class="form-control @error('bloodgroup') is-invalid @enderror" >
                                    <option value="{{Auth::user()->bloodgroup}}">{{Auth::user()->bloodgroup}}</option>
                        ...
                        <div class="col-12">
                            <div class="form-floating mb-3">
                                <input type="tel" class="form-control @error('phone') is-invalid @enderror" name="phone" id="phone" value="{{Auth::user()->phone}}" >
                                @error('phone')
                                    <p style="padding-left:170px; font-size:20px;" class="invalid-feedback">{{ $message }}</p>
                                @enderror
                            </div>
