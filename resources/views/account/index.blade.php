...
<body>
    ...
    <section>
        <div style="text-align: center">
            <button class="btn1" onclick="window.location='{{ url('/account/donate')}} ' ">Do you want to donate ?</button>
            <button class="btn1" onclick="window.location='{{ url('/account/require') }}' ">Do you require the blood? </button>
        </div>
    </section>
    ...
    <section id="call-us">
        <div class="layer">
            <div class="container">
                ...
                <div class="whats">
                    <img src="{{asset('imgs/whats.png')}}" alt="">
                    <h3>+91 9312633729</h3>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="info">
                        ...
                        <h4>Available On</h4>
                        <img src="{{asset('imgs/ios.png')}}" alt="">
                        <img src="{{asset('imgs/google.png')}}" alt="">
                    </div>
                </div>
                <div class="col-md-6">
                    <img class="app-screen" src="{{asset('imgs/App.png')}}" alt="">
                </div>
            </div>
        </div>
    </section>
