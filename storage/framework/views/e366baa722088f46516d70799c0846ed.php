                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            ...
                            <div class="data col-lg-6">
                                <h4>From: <?php echo e($request->sender->name); ?></h4>
                                <h4>Email: <?php echo e($request->sender->email); ?></h4>
                                <h4>Age: <?php echo e($request->sender->age); ?></h4>
                                <h4>Message: <?php echo e($request->message); ?></h4>
                                <h4>Received At: <?php echo e($request->created_at->format('d-m-Y H:i:s')); ?></h4>
                             ...
                             <div class="col-lg-3">
                                <div class="type">
                                        ...
                                        <form method="POST" action="<?php echo e(route('requests.accept', $request->id)); ?>">
                                            <?php echo csrf_field(); ?>
                                        ...
                                        <form method="POST" action="<?php echo e(route('requests.reject', $request->id)); ?>">
                                            <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\blood-donation\resources\views/requests/received.blade.php ENDPATH**/ ?>