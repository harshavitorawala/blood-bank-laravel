...
<div class="container" style="font-size: 20px;">
    ...
    <form action="<?php echo e(route('requests.send')); ?>" method="POST">
        <?php echo csrf_field(); ?>
        <input type="hidden" name="donor_id" value="<?php echo e($donation->user_id); ?>"> 
        <div class="form-group">
            <label for="sender_name">Your Name:</label>
            <input style="font-size: 20px;" type="text" name="sender_name" id="sender_name" class="form-control" value="<?php echo e(Auth::user()->name); ?>" readonly>
        </div>
        <div class="form-group">
            <label for="receiver_name">Receiver's Name:</label>
            <input style="font-size: 20px;" type="text" name="receiver_name" id="receiver_name" class="form-control" value="<?php echo e($donation->user->name); ?>" readonly>
        </div>
        <div class="form-group">
...
<?php /**PATH C:\xampp\htdocs\blood-donation\resources\views/requests/send.blade.php ENDPATH**/ ?>