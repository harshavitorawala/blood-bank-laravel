...
<body>
    ...
    <section id="navigator">
        <div class="container">
            <div class="path">
                ...
                <div class="path-directio" style="color: grey; display:inline-block;"> / Sent Requests</div>
            </div>
    ...
    <section id="requests">
        ...
        <?php if($requests->isEmpty()): ?>
            <h2 style="text-align:center; color:brown" >No requests sent. </h2>
        <?php else: ?>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="type" style="padding-top:20px;">
                                    <h2><?php echo e($request->request_status); ?></h2>
                                </div>
                            </div>
                            <div class="data col-lg-6">
                                <h4>To: <?php echo e($request->receiver->name); ?></h4>
                                <h4>Email: <?php echo e($request->receiver->email); ?></h4>
                                <h4>Message: <?php echo e($request->message); ?></h4>
                                <h4>Sent At: <?php echo e($request->created_at->format('d-m-Y H:i:s')); ?></h4>

                            </div>
                            
                            <div class="col-lg-3">
                                <div class="type">
                                    <form method="POST" action="<?php echo e(route('requests.delete_request', $request->id)); ?>">
                                            <?php echo csrf_field(); ?>
                                            <input name="_method" type="hidden" value="DELETE">
                                            <button type="submit" class="btn btn-xs btn-danger btn-flat show_confirm"  style="width: 200px; padding: 10px; margin-right: 10px;data-toggle=tooltip; margin-top:60px;" title='Delete'>Delete</button>
                                        </form>
                                </div>
                            </div>
...
</html><?php /**PATH C:\xampp\htdocs\blood-donation\resources\views/requests/yourSentRequests.blade.php ENDPATH**/ ?>