...
unset($__errorArgs, $__bag); ?>" name="name" id="name" placeholder="Name" >
...
unset($__errorArgs, $__bag); ?>" name="age" id="age" placeholder="Age" >
                                <?php $__errorArgs = ['age'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" name="phone" id="phone" placeholder="Phone" >
...
</html><?php /**PATH C:\xampp\htdocs\blood-donation\resources\views/account/register.blade.php ENDPATH**/ ?>